...
import 'package:wantermarket/ui/basewidgets/app_bars/app_bar_with_return.dart' show appBarWithReturn;
            ...
            builder: (context, boutiqueFavoriesProvider, _){
              return ListView.separated(
                ...
                itemBuilder: (context, index){
                  return BoutiqueFavorite( boutique: boutiqueFavoriesProvider.boutiquesFavories[index],);
                },
