                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        InkWell(child: Icon(Icons.info_outline, size: 24, color: AppColors.PRIMARY,) ,
                          onTap: (){
                        ...
                        InkWell(child: Icon(Icons.ios_share, size: 24, color: AppColors.PRIMARY,),
                          onTap: (){
              ...
              GridView.builder(
                itemCount: 10,
                  ...
                  itemBuilder: (context, index){
                    return ProduitCardWithoutVendor();
                  }),
